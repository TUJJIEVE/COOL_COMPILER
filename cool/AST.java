...
public class AST{
	...
	public static class dispatches extends expression{
	...
	public static class dispatch extends dispatches{
	...
	public static class static_dispatch extends dispatches{
				public String typeid;
